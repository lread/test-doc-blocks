...
(clojure.test/deftest block-0001
  (clojure.test/testing  "doc/example.adoc - line 14 - The Basics"
...
(clojure.test/deftest block-0002
  (clojure.test/testing  "doc/example.adoc - line 26 - The Basics"
...
(clojure.test/deftest block-0003
  (clojure.test/testing  "doc/example.adoc - line 35 - The Basics"
...
(clojure.test/deftest block-0004
  (clojure.test/testing  "doc/example.adoc - line 88 - The Basics"
...
(clojure.test/deftest block-0006
  (clojure.test/testing  "doc/example.adoc - line 161 - Wrap Test in a Reader Conditional - :reader-cond"
#?(:cljs
(do
...
(clojure.test/deftest block-0007
  (clojure.test/testing  "doc/example.adoc - line 171 - Wrap Test in a Reader Conditional - :reader-cond"
;; And our generic cljc code:
(clojure.test/is (= '[1 2 3] (read-string "[1 2 3]")))))

(clojure.test/deftest ^:testing-meta123 block-0008
  (clojure.test/testing  "doc/example.adoc - line 270 - Specifying Metadata - :meta"
...
(clojure.test/deftest block-0010
  (clojure.test/testing  "doc/example.adoc - line 323 - Section Titles"
nil

(clojure.test/is (= '"well!how!about!that" (string/join "!" ["well" "how" "about" "that"])))))

(clojure.test/deftest block-0011
  (clojure.test/testing  "doc/example.adoc - line 339 - Support for CommonMark Code Block Syntax"
nil

(clojure.test/is (= '{1 :a, 2 :b} (set/map-invert {:a 1 :b 2})))))

(clojure.test/deftest block-0012
  (clojure.test/testing  "doc/example.adoc - line 388 - Test Run Order"
...
(clojure.test/deftest block-0013
  (clojure.test/testing  "doc/example.adoc - line 394 - Test Run Order"
(def var-block2 (+ 4 5 6))

(clojure.test/is (= '21 (+ (fn-block1) var-block2)))))

(clojure.test/deftest block-0014
  (clojure.test/testing  "doc/example.adoc - line 403 - Test Run Order"
