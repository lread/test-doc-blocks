...
(clojure.test/deftest block-0006
  (clojure.test/testing  "doc/example.adoc - line 162 - Wrap Test in a Reader Conditional - :reader-cond"
#?(:cljs
(do
...
(clojure.test/deftest ^:testing-meta123 block-0008
  (clojure.test/testing  "doc/example.adoc - line 271 - Specifying Metadata - :meta"
...
(clojure.test/deftest ^{:testing-meta123 "a-specific-value", :testing-meta789 :yip} block-0009
  (clojure.test/testing  "doc/example.adoc - line 284 - Specifying Metadata - :meta"
...
(clojure.test/deftest block-0010
  (clojure.test/testing  "doc/example.adoc - line 324 - Section Titles"
nil

(clojure.test/is (= '"well!how!about!that" (string/join "!" ["well" "how" "about" "that"])))))

(clojure.test/deftest block-0011
  (clojure.test/testing  "doc/example.adoc - line 340 - Support for CommonMark Code Block Syntax"
nil

(clojure.test/is (= '{1 :a, 2 :b} (set/map-invert {:a 1 :b 2})))))

(clojure.test/deftest block-0012
  (clojure.test/testing  "doc/example.adoc - line 389 - Test Run Order"
...
(clojure.test/deftest block-0013
  (clojure.test/testing  "doc/example.adoc - line 395 - Test Run Order"
(def var-block2 (+ 4 5 6))

(clojure.test/is (= '21 (+ (fn-block1) var-block2)))))

(clojure.test/deftest block-0014
  (clojure.test/testing  "doc/example.adoc - line 404 - Test Run Order"
