...
(clojure.test/deftest block-0004
  (clojure.test/testing  "doc/example.md - line 128 - Wrap Test in a Reader Conditional - :reader-cond"
#?(:clj
(do
...
(clojure.test/deftest block-0005
  (clojure.test/testing  "doc/example.md - line 137 - Wrap Test in a Reader Conditional - :reader-cond"
#?(:cljs
(do
...
(clojure.test/deftest ^:testing-meta123 block-0007
  (clojure.test/testing  "doc/example.md - line 239 - Specifying Metadata - :meta"
...
(clojure.test/deftest ^{:testing-meta123 "a-specific-value", :testing-meta789 :yip} block-0008
  (clojure.test/testing  "doc/example.md - line 250 - Specifying Metadata - :meta"
...
(clojure.test/deftest block-0009
  (clojure.test/testing  "doc/example.md - line 270 - Section Titles"
nil

(clojure.test/is (= '"well!how!about!that" (string/join "!" ["well" "how" "about" "that"])))))

(clojure.test/deftest block-0010
  (clojure.test/testing  "doc/example.md - line 285 - Indented Blocks"
...
(clojure.test/deftest block-0012
  (clojure.test/testing  "doc/example.md - line 345 - Test Run Order"
...
(clojure.test/deftest block-0013
  (clojure.test/testing  "doc/example.md - line 350 - Test Run Order"
...
(clojure.test/deftest block-0014
  (clojure.test/testing  "doc/example.md - line 360 - Test Run Order"
