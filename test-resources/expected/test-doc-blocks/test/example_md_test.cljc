...
(clojure.test/deftest ^{:testing-meta123 "a-specific-value", :testing-meta789 :yip} block-0005
  (clojure.test/testing  "doc/example.md - line 209 - Specifying Metadata"
...
(clojure.test/deftest block-0006
  (clojure.test/testing  "doc/example.md - line 229 - Section Titles"
(clojure.test/is (= '"well!how!about!that" (string/join "!" ["well" "how" "about" "that"])))))

(clojure.test/deftest block-0007
  (clojure.test/testing  "doc/example.md - line 244 - Indented Blocks"
;; we handle simple cases a-OK.
(clojure.test/is (= '6 (+ 1 2 3)))))

(clojure.test/deftest block-0008
  (clojure.test/testing  "doc/example.md - line 252 - Indented Blocks"
...
(clojure.test/deftest block-0009
  (clojure.test/testing  "doc/example.md - line 304 - Test Run Order"
...
(clojure.test/deftest block-0010
  (clojure.test/testing  "doc/example.md - line 309 - Test Run Order"
...
(clojure.test/deftest block-0011
  (clojure.test/testing  "doc/example.md - line 319 - Test Run Order"
