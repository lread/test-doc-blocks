...
* allow for no imposed deps (including test-doc-blocks) for generated tests
...
* consider supporting expressing stdout and stderr as they might naturally be output, they would still bec compared as single blocks, but this might better represent a visual output flow.
** stderr line1
** stdout line1
** stderr line2
** etc..
